...
public:
	reactive_socket_recvfrom_op_base(socket_type socket, int protocol_type,
			...
			reactor_op(&reactive_socket_recvfrom_op_base::do_perform,
					complete_func), socket_(socket), protocol_type_(
					protocol_type), buffers_(buffers), sender_endpoint_(
					endpoint), flags_(flags) {
	}
	...
	static bool do_perform(reactor_op* base) {
		...
		bool result = socket_ops::non_blocking_recvfrom(o->socket_,
				...
				o->sender_endpoint_.data(), &addr_len, o->ec_,
...
class reactive_socket_recvfrom_op: public reactive_socket_recvfrom_op_base<
		MutableBufferSequence, Endpoint> {
public:
	...
	reactive_socket_recvfrom_op(socket_type socket, int protocol_type,
			...
			reactive_socket_recvfrom_op_base<MutableBufferSequence, Endpoint>(
					...
					&reactive_socket_recvfrom_op::do_complete), handler_(

...
public:
	...
	explicit multicast_request(const asio::ip::address_v4& multicast_address,
	...
	explicit multicast_request(const asio::ip::address_v6& multicast_address,

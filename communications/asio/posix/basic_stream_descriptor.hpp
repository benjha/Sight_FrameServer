...
class basic_stream_descriptor: public basic_descriptor<StreamDescriptorService> {
public:
	...
	typedef typename StreamDescriptorService::native_handle_type native_handle_type;

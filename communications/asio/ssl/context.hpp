...
public:
	...
	ASIO_DECL
	context(asio::io_service&, method m);
	 ...
	 */
	ASIO_DECL
	asio::error_code clear_options(options o, asio::error_code& ec);
	 ...
	 */
	ASIO_DECL
	asio::error_code add_certificate_authority(const const_buffer& ca,
			asio::error_code& ec);
	 ...
	 */
	ASIO_DECL
	asio::error_code set_default_verify_paths(asio::error_code& ec);
	 ...
	 */
	ASIO_DECL
	asio::error_code use_certificate(const const_buffer& certificate,
	 ...
	 */
	ASIO_DECL
	asio::error_code use_certificate_chain(const const_buffer& chain,
			asio::error_code& ec);
	 ...
	 */
	ASIO_DECL
	asio::error_code use_certificate_chain_file(const std::string& filename,
			asio::error_code& ec);
	 ...
	 */
	ASIO_DECL
	asio::error_code use_private_key(const const_buffer& private_key,
			file_format format, asio::error_code& ec);
	 ...
	 */
	ASIO_DECL
	void use_rsa_private_key(const const_buffer& private_key,
			file_format format);
	 ...
	 */
	ASIO_DECL
	asio::error_code use_rsa_private_key_file(const std::string& filename,
			file_format format, asio::error_code& ec);
	 ...
	 */
	ASIO_DECL
	asio::error_code use_tmp_dh(const const_buffer& dh, asio::error_code& ec);
...
private:
	...
	ASIO_DECL
	asio::error_code do_set_verify_callback(
			detail::verify_callback_base* callback, asio::error_code& ec);

	// Callback used when the SSL implementation wants to verify a certificate.
	ASIO_DECL
	static int verify_callback_function(int preverified, X509_STORE_CTX* ctx);

	// Helper function used to set a password callback.
	ASIO_DECL
	asio::error_code do_set_password_callback(
			detail::password_callback_base* callback, asio::error_code& ec);

	// Callback used when the SSL implementation wants a password.
	ASIO_DECL
	static int password_callback_function(char* buf, int size, int purpose,
			void* data);

	// Helper function to set the temporary Diffie-Hellman parameters from a BIO.
	ASIO_DECL
	asio::error_code do_use_tmp_dh(BIO* bio, asio::error_code& ec);
